package com.kotlin.springboot.portfolio.domain

import com.kotlin.springboot.portfolio.domain.constant.SkillType
import com.kotlin.springboot.portfolio.domain.entity.*
import com.kotlin.springboot.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val account = Account(
            loginId = "admin1",
            pw = "\$2a\$10\$.snHCYK9S8crOR4sPkRVfuUqpABBjmNSz5P3eAZ482I81peSkCixy"
        )
